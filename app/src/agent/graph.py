...
from agent.nodes.template_reconstructor import reconstruct_template
...
graph = (
    ...
    .add_edge("export_schema_to_json","reconstruct_template")
    .add_edge("reconstruct_template","__end__")
